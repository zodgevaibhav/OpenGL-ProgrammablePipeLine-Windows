...
void initialize(void)
{
	...
	const GLfloat quadsVertices[] =
	{
		...
		-2.0f, 1.0f, 1.0f, //left-top corner of front face
		-2.0f, -1.0f, 1.0f, //left-bottom corner of front face
	...
	const GLfloat quadsVerticesTilted[] =
	{
	...
	glGenBuffers(1, &gVbo_quads_tilted);
	glBindBuffer(GL_ARRAY_BUFFER, gVbo_quads_tilted);
	glBufferData(GL_ARRAY_BUFFER, sizeof(quadsVerticesTilted), quadsVerticesTilted, GL_STATIC_DRAW);
...
void display(void)
{
	...
	modelViewMatrix = translate(-0.8f, 0.0f, -5.0f); //translate function return matrix with translate parameter
	...
	modelViewMatrix = translate(0.0f, 0.0f, -5.0f); //translate function return matrix with translate parameter
