...
// ***********************************  Quods Vertices
	...
	glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST); // set really nice percpective calculations ?
	...
	gPerspectiveProjectionMatrix = mat4::identity(); // set perspective matrix to identitu matrix
